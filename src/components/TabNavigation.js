...
const tabs = [
    ...
    { id: 'feed', label: 'Feed', icon: _jsx(TrendingUp, { size: 24 }) },
    { id: 'terminal', label: 'AI Terminal', icon: _jsx(Zap, { size: 24 }) },
    { id: 'settings', label: 'Settings', icon: _jsx(Settings, { size: 24 }) },
];
