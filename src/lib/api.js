...
function getMockAnalysis() {
    return {
        market_analysis: 'Current market shows strong institutional buying signals with SEC ETF approvals driving positive sentiment. Bitcoin is consolidating at key resistance while Ethereum benefits from protocol upgrades. However, whale movements suggest profit-taking risks in the short term.',
